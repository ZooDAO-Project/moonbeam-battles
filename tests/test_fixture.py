...
def test_second_stage(accounts, second_stage):
	...
	(vault, functions, governance, staking, voting, arena, listingList, xZoo, jackpotA, jackpotB) = second_stage[1]
...
def test_third_stage(accounts, third_stage):
	...
	(vault, functions, governance, staking, voting, arena, listingList, xZoo, jackpotA, jackpotB) = third_stage[1]
...
def test_fourth_stage(accounts, fourth_stage):
	...
	(vault, functions, governance, staking, voting, arena, listingList, xZoo, jackpotA, jackpotB) = fourth_stage[1]
...
def test_fifth_stage(accounts, fifth_stage):
	...
	(vault, functions, governance, staking, voting, arena, listingList, xZoo, jackpotA, jackpotB) = fifth_stage[1]
...
def test_finished_epoch(accounts, finished_epoch):
	...
	(vault, functions, governance, staking, voting, arena, listingList, xZoo, jackpotA, jackpotB) = finished_epoch[1]
