...
def test_removing_already_removed_position(accounts, battles, tokens):
	...
	voting.createNewVotingPosition(3, 10e18, _from(accounts[0]))
	...
	with brownie.reverts("Nft unstaked"):
...
def test_removing_from_active_staking_positions(accounts, battles, tokens):
	...
	# checking i < numberOfNftsWithNonZeroVotes
	voting.createNewVotingPosition(1, 100e18, _from(accounts[0]))
	voting.createNewVotingPosition(2, 100e18, _from(accounts[0]))
...
def test_array_structure_consistency(accounts, battles, tokens):
	...
	voting.createNewVotingPosition(1, 10e18, _from(accounts[0]))
	voting.createNewVotingPosition(4, 10e18, _from(accounts[0]))
	voting.createNewVotingPosition(3, 10e18, _from(accounts[0]))
	voting.createNewVotingPosition(5, 10e18, _from(accounts[0]))
...
def test_removing_from_active_staking_positions_with_votes(accounts, battles, tokens):
	...
	voting.createNewVotingPosition(1, 10e18, _from(accounts[0]))
	voting.createNewVotingPosition(2, 10e18, _from(accounts[0]))
	voting.createNewVotingPosition(3, 10e18, _from(accounts[0]))
