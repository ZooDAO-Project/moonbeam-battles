...
def test_battles_workflow_basic(accounts, tokens, battles):
	...
	voting.createNewVotingPosition(1, value, _from(accounts[1])) # stakingPositionId, value, from
	voting.createNewVotingPosition(2, value, _from(accounts[1])) # stakingPositionId, value, from
	voting.createNewVotingPosition(3, value, _from(accounts[1])) # stakingPositionId, value, from
...
def test_battles_workflow_advanced(accounts, tokens, battles):
	...
	daiToken.approve(voting.address, value*3, _from(accounts[1])) # address, value, from
	voting.createNewVotingPosition(1, value, _from(accounts[1])) # stakingPositionId, value, from // position 1
	voting.createNewVotingPosition(2, value, _from(accounts[1])) # stakingPositionId, value, from // position 2
	voting.createNewVotingPosition(3, value, _from(accounts[1])) # stakingPositionId, value, from // position 3
	...
	voting.createNewVotingPosition(4, value, _from(accounts[1])) # stakingPositionId, value, from // position 4
	voting.createNewVotingPosition(3, value, _from(accounts[2])) # stakingPositionId, value, from // position 5
